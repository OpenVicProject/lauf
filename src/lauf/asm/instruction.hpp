...
std::ptrdiff_t new_compress_pointer_offset(CurType* _cur, DestType* _dest)
{
    auto cur  = (char*)(_cur);
...
const DestType* new_uncompress_pointer_offset(CurType* cur, std::ptrdiff_t offset)
{
...
{
    return (DestType*)(reinterpret_cast<void* const*>(cur) + offset);
}
